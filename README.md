...
Hello-Microverse is an introductory project to practice my Github flow skills and getting familiar working with linters.
...
- A HTML file with the text "Hello Microverse!"
- A CSS file 
- A gitignore and README files.
...
No futures features are planned for this project.
...
I would like to thank Microverse and my code reviewer for their help.
